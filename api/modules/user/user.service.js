...
import {
    countAllUsers as countAllUsersRepo,
    countUsersCreatedAfter as countUsersCreatedAfterRepo,
    deleteUserById as deleteUserByIdRepo,
    findUserById as findUserByIdRepo,
    findUsersWithPagination as findUsersWithPaginationRepo,
...
export const getUserById = async (userId, { excludePassword = false } = {}) => {
    const user = await findUserByIdRepo(userId, { excludePassword });
...
export const updateUserById = async (userId, updates = {}) => {
    const userToUpdate = await findUserByIdRepo(userId);
...
export const deleteUserById = async (userId) => {
    const deleted = await deleteUserByIdRepo(userId);
...
export const findUsersWithPagination = (startIndex, limit, sortDirection) => {
    return findUsersWithPaginationRepo(startIndex, limit, sortDirection);
};
...
export const countUsersCreatedAfter = (date) => {
    return countUsersCreatedAfterRepo(date);
};
